(function(global, factory) {
    ...
    function toWindow(element) {
        ...
        return isWindow(element) ? element : (isDocument(element) ? element : element.ownerDocument).defaultView;
    }
    ...
    function scrollParents(element, overflowRe) {
        ...
        return element ? parents(element, "*").filter(function(parent) {
            return parent === scrollEl || overflowRe.test(css(parent, "overflow")) && parent.scrollHeight > offset(parent).height;
        }).reverse() : [ scrollEl ];
    }
